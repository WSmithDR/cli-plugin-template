...
| [`docs-conventions`](features/docs-conventions/README.md) | 1.1.0 | todos | Secciones estándar de README: install, update, verificación de versión, tabla de conventional commits |
